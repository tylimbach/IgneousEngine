...
namespace bve {
    ...
    VulkanBuffer::VulkanBuffer(
        ...
        : bveDevice{ device }, instanceCount{instanceCount}, instanceSize{instanceSize}, usageFlags{ usageFlags }, memoryPropertyFlags{ memoryPropertyFlags } {
    ...
    VulkanBuffer::~VulkanBuffer() {
        unmap();
        vkDestroyBuffer(bveDevice.device(), buffer, nullptr);
        vkFreeMemory(bveDevice.device(), memory, nullptr);
    }
    ...
    VkResult VulkanBuffer::map(VkDeviceSize size, VkDeviceSize offset) {
        ...
        return vkMapMemory(bveDevice.device(), memory, offset, size, 0, &mapped);
    }
    ...
    void VulkanBuffer::unmap() {
        if (mapped) {
            vkUnmapMemory(bveDevice.device(), memory);
            mapped = nullptr;
        }
    }
    ...
    VkResult VulkanBuffer::flush(VkDeviceSize size, VkDeviceSize offset) {
        ...
        return vkFlushMappedMemoryRanges(bveDevice.device(), 1, &mappedRange);
    }
    ...
    VkResult VulkanBuffer::invalidate(VkDeviceSize size, VkDeviceSize offset) {
        ...
        mappedRange.offset = offset;
        mappedRange.size = size;
        return vkInvalidateMappedMemoryRanges(bveDevice.device(), 1, &mappedRange);
    }
